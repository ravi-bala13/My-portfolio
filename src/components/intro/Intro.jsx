  ...
  return (
      <div className="intro" id="intro">
        ...
        <div className="wrapper">
          ...
          <button className="btn" onClick={() => window.open("assets/fw12_119_bala_murugan.pdf", "_blank")}><span><DescriptionIcon style={{height:"17px", width:"20px"}}/></span>Resume</button>
        </div>
        <a href="#portfolio">
      ...
      <div className="left">
        <div className="imgContainer">
          ...
          <img src="assets/balapic.jpg" alt="" />
        </div>
      </div>
